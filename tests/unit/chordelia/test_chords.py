...
class TestChordScoreEvents:
    ...
    def test_chord_emits_single_score_event_with_all_tones(self):
        ...
        render = Chord.from_string("C4").render_for_context(context)
        ...
        assert render.consumed_duration == Duration.from_beats(3, 4)
    ...
    def test_chord_without_octave_raises_value_error(self):
        ...
        with pytest.raises(ValueError, match="requires octave information"):
            Chord.from_string("C").render_for_context(ScoreEventContext())
    ...
    def test_chord_event_uses_context_channel_voice_and_offset(self):
        ...
        render = Chord("C4").render_for_context(context)
        ...
        assert render.consumed_duration == Duration.from_beats(1, 8)
    ...
    def test_chord_with_inversion_emits_inverted_pitch_order(self):
        ...
        event = Chord("C4", inversion=1).render_for_context(ScoreEventContext()).events[0]
    ...
    def test_chord_with_bass_note_inserts_bass_first(self):
        ...
        event = Chord("C4", bass_note="B3").render_for_context(ScoreEventContext()).events[0]
    ...
    def test_chord_with_any_tone_missing_octave_raises_value_error(self):
        ...
        with pytest.raises(ValueError, match="requires octave information"):
            chord.render_for_context(ScoreEventContext())
